...
function lt_first_step(stringerParams) {
    ...
    if (stringerParams.stringerType == "прямая") {
        ...
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, fil1.end, fil3.start, dxfBasePoint);
        addArc(stringerParams.stringerShape, dxfPrimitivesArr, fil3.center, stringerParams.rad1, fil3.angstart, fil3.angend, dxfBasePoint);

        var p_t1 = newPoint_xy(p1, stringerParams.b1 * (stringerParams.stairAmt - 1), stringerParams.h1 * (stringerParams.stairAmt - 1));
        var p_t2 = newPoint_xy(p_t1, stringerParams.b1, 0.0);
        var fil_t1 = fillet(p1, stringerParams.stairAngle1, p_t2, Math.PI, stringerParams.rad1);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, fil3.end, fil_t1.start, dxfBasePoint);
        addArc(stringerParams.stringerShape, dxfPrimitivesArr, fil_t1.center, stringerParams.rad1, fil_t1.angstart, fil_t1.angend, dxfBasePoint);
...
function ko_middle_steps(stringerParams) {
    ...
    //      var i = 2;
    //      var p2 = copyPoint(stringerParams.pstart);
    ...
    //          p1 = copyPoint(p3);
    //      }
    //      stringerParams.pstart = copyPoint(p2);
    //  }    
}
...
function lt_last_step(stringerParams) {
    if (stringerParams.stringerType == "прямая") {
        ...
        var p1 = newPoint_xy(p2, 0.0, -stringerParams.h1);
        ...
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, stringerParams.fil_t1.end, p2, dxfBasePoint);
    }
    ...
    if (stringerParams.stringerType == "ломаная") {
        var px = p2.x - p1.x - stringerParams.stringerWidth;

        var p1 = newPoint_xy(p2, 0.0, -stringerParams.h1 - 5.0);

        //var px = stringerParams.b1 - (stringerParams.bottomLineP1.x - stringerParams.p0.x - stringerParams.b1);
        //var px = stringerParams.b1 - stringerParams.stringerWidth;
        
        var p11 = newPoint_xy(p1, -px, 0.0);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, p2, newPoint_xy(p1, 0.0, stringerParams.rad1), dxfBasePoint);

        var pc1 = newPoint_xy(p1, -stringerParams.rad1, stringerParams.rad1);
        addArc(stringerParams.stringerShape, dxfPrimitivesArr, pc1, stringerParams.rad1, Math.PI * 2.0, Math.PI * 1.5, dxfBasePoint);

        addLine(stringerParams.stringerShape, dxfPrimitivesArr, newPoint_xy(p1, -stringerParams.rad1, 0.0), newPoint_xy(p11, stringerParams.rad2, 0.0), dxfBasePoint);

        var pc11 = newPoint_xy(p11, stringerParams.rad2, -stringerParams.rad2);
        addArc(stringerParams.stringerShape, dxfPrimitivesArr, pc11, stringerParams.rad2, Math.PI * 0.5, Math.PI, dxfBasePoint);

        // нижняя линия марша

        var p22 = newPoint_xy(p11, 0.0, -stringerParams.h1);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, newPoint_xy(p11, 0.0, -stringerParams.rad2), newPoint_xy(p22, 0.0, stringerParams.rad1), dxfBasePoint);
        ...
        for (; i < stringerParams.stairAmt; i++) {
            ...
            var p11 = newPoint_xy(p1, -stringerParams.b1, 0.0);
            var p22 = newPoint_xy(p11, 0.0, -stringerParams.h1);
        ...
        addArc(stringerParams.stringerShape, dxfPrimitivesArr, pc1, stringerParams.rad1, Math.PI * 2.0, Math.PI * 1.5, dxfBasePoint);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, newPoint_xy(p22, -stringerParams.rad1, 0.0), stringerParams.pstart, dxfBasePoint);
    }
    else {
...
function ko_last_step(stringerParams) {
    ...
    if (stringerParams.stringerType == "ломаная") {
        var p1 = newPoint_xy(p0, stringerParams.b1, 0.0);
        var p11 = polar(p1, stringerParams.stairAngle1, 100.0);
        // Задняя кромка
        var p00 = newPoint_xy(p2, 0.0, -100.0);
        var bottomLineP2 = itercection(p2, p00, p1, p11); // точка пересечения нижней линии марша и задней кромки

        var p1 = newPoint_xy(p2, 0.0, -stringerParams.h1 + stringerParams.treadThickness);
        var p11 = newPoint_xy(p1, -(stringerParams.b1 - (stringerParams.pstart.x - stringerParams.p0.x - stringerParams.b1)), 0.0);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, p2, p1, dxfBasePoint);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, p1, p11, dxfBasePoint);
        ...
        //    var p3 = newPoint_xy(p1, 0.0, stringerParams.h1);
        //    var p2 = newPoint_xy(p3, stringerParams.b1, 0.0);
        //    var p2 = newPoint_xy(p2, 0.0, stringerParams.h1);
        //}
        p4 = copyPoint(p11);

        // нижняя линия марша
        //addLine(stringerParams.stringerShape, dxfPrimitivesArr, bottomLineP2, p4, dxfBasePoint);

        var p22 = newPoint_xy(p4, 0.0, -stringerParams.h1);
        addLine(stringerParams.stringerShape, dxfPrimitivesArr, p4, p22, dxfBasePoint);
        ...
        for (; i < stringerParams.stairAmt; i++) {
            ...
            if (i == stringerParams.stairAmt - stringerParams.divide + 1) {
                var p3 = newPoint_xy(p1, 0.0, -stringerParams.h1);
                var p22 = newPoint_xy(p3, -stringerParams.b1, 0.0);
            } else {
                var p3 = newPoint_xy(p1, -stringerParams.b1, 0.0);
                var p22 = newPoint_xy(p3, 0.0, -stringerParams.h1);
            }
            addLine(stringerParams.stringerShape, dxfPrimitivesArr, p1, p3, dxfBasePoint);
            addLine(stringerParams.stringerShape, dxfPrimitivesArr, p3, p22, dxfBasePoint);
        }
    }
    else {
        // Задняя кромка
